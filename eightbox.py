...
from clean_moves_manager import CleanMovesManager
...
class MainApp(QMainWindow):
    ...
    def __init__(self):
        ...
        self.clean_moves_manager = CleanMovesManager(self)
    ...
    def show_clean_moves_dialog(self):
        ...
        self.clean_moves_manager.show_clean_moves_dialog()

    def handle_cleaned_moves(self, cleaned_moves, current_data):
        """Handle cleaned moves data from the dialog."""
        self.clean_moves_manager.handle_cleaned_moves(cleaned_moves, current_data)
