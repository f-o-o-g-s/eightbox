...
def sanitize_database(input_db, output_db):
    ...
    try:
        ...
        with open("name_mapping.txt", "w") as f:
            ...
            unique_last_names = len(
                set(fake.split(",")[0] for fake in name_mapping.values())
            )
        ...
        print("Sanitized database saved to: " + output_db)
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        description="Sanitize a database by anonymizing sensitive data."
    )
